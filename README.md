...
Every workflow in the library has a folder here with runnable sample code: Claude Code dynamic workflow scripts, subagent definitions, prompts, capture scripts, and packet templates you can copy into your own project.
...
- `README.md` — what the workflow does, prerequisites, and how to run the samples
- `workflow.md` — the prompt you give Claude Code to generate or run the workflow
- Scripts, subagent definitions (`.claude/agents/`), and packet templates referenced by the article

## Requirements

Most samples target [Claude Code](https://code.claude.com) v2.1.154+ with dynamic workflows enabled. Capture scripts use Node 20+ and Playwright.
